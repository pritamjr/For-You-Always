...
export default function FinalNote() {
  ...
  const fullText = "Loving you is not something I do—it's who I am. In every breath, every silence, every tomorrow, it's you. Happy Girlfriend's Day to the one my heart chose long before I ever understood love.";
            ...
            >
              ...
              >
                ...
                <span className="font-serif text-xs sm:text-sm text-gray-500 italic">
                  Girlfriend's Day {new Date().getFullYear()}
                </span>
              </motion.div>
            </motion.div>
